...
export const WhyOrganic = () => (
    <section
        ...
        className="noise relative overflow-hidden bg-[#0F4C26] py-24 md:py-32"
    >
        <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-10">
            <Reveal>
                <Chapter label="Why Organic" light />
                <div className="flex flex-wrap items-end justify-between gap-6">
                    <h2 className="font-display max-w-2xl text-4xl font-medium leading-tight tracking-tight text-white sm:text-5xl">
            ...
            <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                {BENEFITS.map((b, i) => (
                    <Reveal key={b.title} delay={(i % 4) * 0.08}>
                        ...
                        >
                            <b.icon size={24} className="text-[#E9C96A]" aria-hidden="true" />
